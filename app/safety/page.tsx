    ...
    <>
      <section className="page-hero">
        <div className="wrap">
          ...
          <p className="lede">
            Safety here is a set of working rules, not a slogan. This page describes what
            those rules are — and is honest about what no service can absolutely promise.
          </p>
        </div>
      </section>
      ...
      <section className="section section-deep">
        <div className="wrap">
          ...
          <div className="prose">
            ...
            <p>
              Members will be able to raise a concern about any interaction. Every report is
              documented and reviewed against these standards, and outcomes can include a
              warning, suspension, or removal. The person who reported is told the outcome.
            </p>
            <h2>Honest limits</h2>
            <p>
              No service can absolutely prevent someone from misrepresenting themselves,
              taking a screenshot, or behaving badly in person. What we can do — and commit
              to — is verify identity before membership begins, control who sees what,
              require mutual agreement before contact, and act on every report. We will not
              promise more than that, because nobody honestly can.
            </p>
          </div>
        </div>
      </section>
